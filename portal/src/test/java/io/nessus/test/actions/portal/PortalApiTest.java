...
public class PortalApiTest extends AbstractPortalTest {
	...
	public void testUserLifecycle() throws Exception {
		...
		// POST http://localhost:8280/portal/api/users
		// 
		// {
		//	  "firstName": "My",
		//	  "lastName":  "User", 
		...
		// POST http://localhost:8280/portal/api/user/token
		...
		// GET http://localhost:8280/portal/api/user/status
		...
		// DELETE http://localhost:8280/portal/api/user
		// Authorization: "Bearer eyJhbGciOi..."
